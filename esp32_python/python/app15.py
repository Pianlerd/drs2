...
def _handle_disquantity_logic(cursor, is_sensor_trigger=False, flash_func=None):
    """
    ...
    if is_sensor_trigger:
        ...
        # Clear global variable immediately after retrieving for processing
        current_item_awaiting_drop = None 
    ...
    if request.method == 'POST':
        ...
        if action == 'add_disquantity':
            ...
            if not conn_reset:
                ...
                # Redirect, but still try to preserve the barcode ID
